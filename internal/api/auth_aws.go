...
// isEnvTruthy returns true if the given environment variable value represents a truthy value.
func isEnvTruthy(value string) bool {
	lower := strings.ToLower(value)
	return lower == "true" || lower == "1" || lower == "yes"
}

// getAWSRegion returns the AWS region from environment variables, defaulting to us-east-1.
...
// getVertexRegionForModel returns the Vertex AI region for the given model.
